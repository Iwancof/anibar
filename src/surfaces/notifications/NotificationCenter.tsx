...
export default function NotificationCenter(props: NotificationCenterProps) {
  ...
  return (
    ...
    >
      <box class="NotifCenterPanel UiPanel" orientation={Gtk.Orientation.VERTICAL} spacing={0}>
        <PanelHeader title="NOTIF::HISTORY" meta={headerMeta} />
        <box class="NotifCenterBody UiPanelBody" orientation={Gtk.Orientation.VERTICAL} spacing={8}>
